...
def convert_result(res_folder, kde_cutoff, net_format):
    ...
    for direction in ["decreased", "increased"]:
        ...
        for kde in kde_cutoff:
            ...
            # Move KDE_egos.txt.
            srcf = [file_name for file_name in direction_files if "_sig_cluster_" in file_name and str(kde)+".txt" in file_name]
            ...
            srcf = [file_name for file_name in direction_files if "_sig_fisher_" in file_name and str(kde)+"_" in file_name]
            for file in srcf:
                new_file = file.split("_")[-1]
            ...
            # Move supernodes_net.
            srcf = [file_name for file_name in direction_files if "_supernodes_net_" in file_name and str(kde)+".txt" in file_name]
            ...
            srcf = [file_name for file_name in direction_files if str(kde)+"."+net_format in file_name]
            for file in srcf:
            ...
            srcf = [file_name for file_name in direction_files if "module_net_" in file_name and str(kde)+".csv" in file_name]
            for file in srcf:
            ...
            for file_name in direction_files:
                if("module_" in file_name and "cluster_"+str(kde)+".txt" in file_name):
            ...
            for module in direction_module_names:
                ...
                srcf = [file_name for file_name in direction_files if module in file_name and "_cluster_" in file_name and str(kde)+".txt" in file_name]
                for file in srcf:
                ...
                srcf = [file_name for file_name in direction_files if module in file_name and "_fisher_" in file_name and str(kde)+"_" in file_name]
                for file in srcf:
                    new_file = file.split("_")[-1]
