...
def phuego_sc(support_data_folder, res_folder, test_path, 
...
#            sys.exit("damping should be a float number within range [0.5, 0.95]")
    ...
    receptor_tf_path = support_data_folder + "receptor_tf.txt"
    ...
    load seeds.
    """
    seeds_pos,seeds_neg,seeds,zscores_global,ssim = load_seeds_sc(
                     receptor_tf_path=receptor_tf_path,
